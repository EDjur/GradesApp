...
public class MFOM1 extends AppCompatActivity implements Module {
    ...
    public void addAssignment(View view) {
        RelativeLayout parentLayout = (RelativeLayout) findViewById(R.id.manSci_firstYear_mfom1_relative_layout);
    ...
    public int getAssignmentId(int index) {
        switch (index) {
            case 0:
                return R.id.mfom1_assignment_1;
            case 1:
                return R.id.mfom1_assignment_2;
            case 2:
                return R.id.mfom1_assignment_3;
            case 3:
                return R.id.mfom1_assignment_4;
        }
        return 0;
    }
    ...
    public int getWeightId(int index) {
        switch (index) {
            case 0:
                return R.id.mfom1_assignment_1_weight;
            case 1:
                return R.id.mfom1_assignment_2_weight;
            case 2:
                return R.id.mfom1_assignment_3_weight;
            case 3:
                return R.id.mfom1_assignment_4_weight;
        }
        return 0;
    }
    ...
    public int getGradeId(int index) {
        switch (index) {
            case 0:
                return R.id.mfom1_assignment_1_grade;
            case 1:
                return R.id.mfom1_assignment_2_grade;
            case 2:
                return R.id.mfom1_assignment_3_grade;
            case 3:
                return R.id.mfom1_assignment_4_grade;
        }
        return 0;
    }
}