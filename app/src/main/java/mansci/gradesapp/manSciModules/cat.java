    ...
    public void addAssignment(View view) {
        ...
        switch (number_of_assignments) {
            case 0:
                ...
                assignment1.setId(R.id.cat_assignment_1);
            ...
            case 1:
                ...
                assignment2.setId(R.id.cat_assignment_2);
                assignment2.setTextSize(TypedValue.COMPLEX_UNIT_SP, 25);
                lp.addRule(RelativeLayout.BELOW, R.id.cat_assignment_1);
                lp.setMargins(0, 0, 0, (int) getResources().getDimension(R.dimen.six_dp));
            ...
            case 2:
                ...
                assignment3.setId(R.id.cat_assignment_3);
                assignment3.setTextSize(TypedValue.COMPLEX_UNIT_SP, 25);
                lp.addRule(RelativeLayout.BELOW, R.id.cat_assignment_2);
                lp.setMargins(0, 0, 0, (int) getResources().getDimension(R.dimen.six_dp));
            ...
            case 3:
                ...
                assignment4.setId(R.id.cat_assignment_4);
                assignment4.setTextSize(TypedValue.COMPLEX_UNIT_SP, 25);
                lp.addRule(RelativeLayout.BELOW, R.id.cat_assignment_3);
                lp.setMargins(0, 0, 0, (int) getResources().getDimension(R.dimen.six_dp));
